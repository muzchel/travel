...
public class Tour3DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tour3_detail);
        Log.d("Tour3DetailActivity", "Activity created");
        ...
        buttonProfile.setOnClickListener(v -> startActivity(new Intent(Tour3DetailActivity.this, ProfileActivity.class)));
        buttonHome.setOnClickListener(v -> startActivity(new Intent(Tour3DetailActivity.this, MainActivity.class)));
        buttonSettings.setOnClickListener(v -> startActivity(new Intent(Tour3DetailActivity.this, SettingsActivity.class)));
